package com.experiments.newsy.widget;
...
public class SavedNewsService extends IntentService {
    ...
    public static final String ACTION_GET_NEXT = "com.experiments.newsy.widget.action.saved.next";
    public static final String ACTION_GET_PREVIOUS = "com.experiments.newsy.widget.action.saved.previous";
    private static final String ACTION_UPDATE_WIDGETS = "com.experiments.newsy.widget.action.update_widgets";

    public static final String PARAM_CURRENT = "com.experiments.newsy.widget.extra.current_selected";
