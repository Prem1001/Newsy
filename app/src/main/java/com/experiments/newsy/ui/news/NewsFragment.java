...
import com.experiments.newsy.adapters.NewsAdapter;
import com.experiments.newsy.databinding.NewsFragmentBinding;
...
public class NewsFragment extends Fragment implements NewsAdapter.NewsAdapterListener {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (showSaved) {
            ...
            specs.setCountry(countryCodeValue);
            viewModel.getNewsHeadlines(specs).observe(getViewLifecycleOwner(), articles -> {
                if (articles != null) {
                    newsAdapter.setArticles(articles);
                    restoreRecyclerViewState();
                }
